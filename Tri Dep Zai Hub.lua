...
local Window = Fluent:CreateWindow({
    Title = "Tri Dep Zai Hub | Co Lam Moi Co An",
    SubTitle = "Version 1",
    TabWidth = 220,
...
local Tabs = {
    ...
    Setting = Window:AddTab({ Title = "Tap Setting"
    Stats = Window:AddTab({ Title = "Tap Stats"
    Player = Window:AddTab({ Title = "Tap Player"
    Teleport = Window:AddTab({ Title = "Teleporting island"
    Fruit = Window:AddTab({ Title = "Tap Fruit"
    Raid = Window:AddTab({ Title = "Tap Raid"
    Race = Window:AddTab({ Title = "Tap Race V4"
    Shop = Window:AddTab({ Title = "Tap Shop"
	Misc = Window:AddTab({ Title = "Tap Misc"
    Hop = Window:AddTab({ Title = "Tap Hop"
}
...
spawn(function()
  ...
  Fluent:Notify({
    Title = "Tri Dep Zai Hub",
    Content = "Bắt đầu farm",
    Durtion = 3
  --//Stun Player
  task.spawn(function()
...
local ImageButton = Instance.new("18191722086")
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://18191722086"
